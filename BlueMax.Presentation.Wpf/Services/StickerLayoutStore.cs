...
public class StickerItemSettings
{
    ...
    public string TextAlignment { get; set; } = "Right"; // Left, Center, Right
    public bool IsBold { get; set; } = false;
    public bool IsItalic { get; set; } = false;
    public bool IsUnderline { get; set; } = false;
    public string VariableBinding { get; set; } = ""; // Empty for static text, or variable key like "brand", "model", etc.
...
public class StickerLayoutStore
{
    ...
    public StickerLayoutStore()
    {
        ...
        var dir = string.IsNullOrWhiteSpace(appData)
            ? string.Empty
            : Path.Combine(appData, "BlueMax", "Config");
    ...
    public StickerLayoutSettings CreateDefaultSettings()
    {
        ...
        return new StickerLayoutSettings
        {
            ...
            Items = new List<StickerItemSettings>
            {
                ...
                new StickerItemSettings { Key = "line_bottom", X = 10, Y = 136, Width = 206, Height = 1.5, FontSize = 1, DisplayText = "" },
                new StickerItemSettings { Key = "address", X = 0, Y = 141, Width = 226, Height = 18, FontSize = 10, DisplayText = "Address line" },
                new StickerItemSettings { Key = "phone", X = 0, Y = 165, Width = 226, Height = 18, FontSize = 10, DisplayText = "Phone: " },
